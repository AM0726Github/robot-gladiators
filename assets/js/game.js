...
var fight = function(enemy) {
  ...
  while (playerInfo.health > 0 && enemy.health > 0) {
    ...
    // generating random damage value based on player's attack power
    ...
    // generating random damage for enemy attack power
...
var startGame = function() {
  ...
  //reset enemy states healt (20 to 60) random value
  ...
  for (var i = 0; i < enemyInfo.length; i++) {
    ...
    if (playerInfo.health > 0) {
      ...
      if (playerInfo.health > 0 && i< enemyInfo.length - 1){
        // ask if player wantsto use the store before next round
        var storeConfirm = window.confirm("The fight is over, visit the store before next round?")
        // if yes, take them to the store() funktion
        if (storeConfirm){
          shop();
        }
      }
...
// expression of the shop function
var shop = function() {
